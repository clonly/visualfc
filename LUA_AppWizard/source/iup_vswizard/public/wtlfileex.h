...
class CTextWriteFile : public CFile
{
public:
	BOOL Open(LPCTSTR lpszFileName, UINT uOpenFlags = CFile::modeWrite| CFile::modeCreate | CFile::shareDenyNone)
	{
		return CFile::Open(lpszFileName,uOpenFlags);
	}

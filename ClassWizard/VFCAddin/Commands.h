...
#if !defined(AFX_COMMANDS_H__A3A9CF9F_9E11_4828_BD1C_D7B3C655482A__INCLUDED_)
#define AFX_COMMANDS_H__A3A9CF9F_9E11_4828_BD1C_D7B3C655482A__INCLUDED_

#include "VFCAddinTypes.h"
#include "../public/vs60_addin.h"

class CCommands : 
	public CComDualImpl<ICommands, &IID_ICommands, &LIBID_VFCAddin>, 
...
protected:
	...
	class XApplicationEvents : public XEventHandler<IApplicationEvents, 
		&IID_IApplicationEvents, &LIBID_VFCAddin, 
	...
	class XDebuggerEvents : public XEventHandler<IDebuggerEvents, 
		&IID_IDebuggerEvents, &LIBID_VFCAddin, 
...
public:
// ICommands methods
	STDMETHOD(VFCAddinCommandMethod)(THIS);
};
...
#endif // !defined(AFX_COMMANDS_H__A3A9CF9F_9E11_4828_BD1C_D7B3C655482A__INCLUDED)

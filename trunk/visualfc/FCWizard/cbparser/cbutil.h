...
#define _CBUTIL_H__
/*
int __cdecl wxMessageBox(wxString const & str)
{
	::MessageBox(GetActiveWindow(),str,"Error",0);
	return 0;
}
*/
...
{
	wxCommandEvent2(wxEventType commandType = wxEVT_NULL, int winid = 0)
	{
	}
};

/*
inline wxCommandEvent::wxCommandEvent(wxEventType commandType, int winid)
{
}

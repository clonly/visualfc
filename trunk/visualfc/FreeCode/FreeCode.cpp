// FreeCode.cpp : Defines the initialization routines for the DLL.
//
...
class CFreeCodeApp : public CWinApp
{
public:
	CFreeCodeApp();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CFreeCodeApp)
	public:
	virtual BOOL InitInstance();
	virtual int ExitInstance();
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CFreeCodeApp)
...
BEGIN_MESSAGE_MAP(CFreeCodeApp, CWinApp)
	//{{AFX_MSG_MAP(CFreeCodeApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CFreeCodeApp object

CFreeCodeApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CFreeCodeApp construction

CFreeCodeApp::CFreeCodeApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// CFreeCodeApp initialization

BOOL CFreeCodeApp::InitInstance()
{
	_Module.Init(ObjectMap, m_hInstance);
	return CWinApp::InitInstance();
}

int CFreeCodeApp::ExitInstance()
{
	_Module.Term();
...
//	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	...
	if (lRes == ERROR_SUCCESS)
	{
		...
		if (lRes == ERROR_SUCCESS)
		{
			...
			strDescription.LoadString(IDS_FREECODE_DESCRIPTION);

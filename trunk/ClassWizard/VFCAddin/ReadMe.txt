========================================================================
       DEVELOPER STUDIO ADD-IN : VFCAddin
========================================================================


The Add-in Wizard has created this VFCAddin DLL for you.  This DLL not only
...
VFCAddin.cpp
	This is the main DLL source file.  It contains the class CVFCAddinApp.
...
Commands.cpp, Commands.h
    ...
    a sample command (VFCAddinCommand) which displays a message
...
StdAfx.h, StdAfx.cpp
    ...
    named VFCAddin.pch and a precompiled types file named StdAfx.obj.

...
void CCommands::SetApplicationObject(IApplication* pApplication)
{
	...
	m_addin.m_pApplication = m_pApplication;
	m_addin.m_fc.load(_Module.m_hInst,&m_addin);
}
...
STDMETHODIMP CCommands::VFCAddinCommandMethod() 
{
	...
	//::MessageBox(NULL, "VFCAddin Command invoked.", "VFCAddin", MB_OK | MB_ICONINFORMATION);

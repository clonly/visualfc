...
wxString Tokenizer::GetTokenExt(bool bGetValue)
{
	m_UndoTokenIndex = m_TokenIndex;
	m_UndoLineNumber = m_LineNumber;
	m_UndoNestLevel = m_NestLevel;
	return DoGetToken(bGetValue);
}


wxString Tokenizer::GetEnumToken()
{
	m_UndoTokenIndex = m_TokenIndex;
	m_UndoLineNumber = m_LineNumber;
	m_UndoNestLevel = m_NestLevel;
	return DoGetToken(true);
}
...
wxString Tokenizer::DoGetToken(bool bGetValue)
{
	if (IsEOF())

...
namespace fox
{
	...
	public:
		...
		virtual size_t get_file_count(const char * project_name) = 0;
		virtual const char * get_files(const char * project_name, int i) = 0;
	};
	class vs60_addin : public vs_addin
	{
	public:
		virtual int get_version() { return 0x60;}
		virtual char * get_addin_name() { return "VS60 Addin"; }
	};
	class vs2005_addin : public vs_addin
	{
	public:
		virtual int get_version() { return 0x2005; }
		virtual char * get_addin_name() { return "VS2005 Addin"; }
	};
	namespace ui
	{
		class base
		...
		public:
			...
			virtual void  load_project(HWND hParent, const char * name, const char * activefile, bool bAppend) = 0;
		};	

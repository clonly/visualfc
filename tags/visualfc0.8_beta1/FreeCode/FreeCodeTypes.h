...
/* at Mon Nov 12 09:37:23 2007
 */
/* Compiler settings for E:\FreeCode0.52b\sources\FreeCode\FreeCode.odl:
...
DEFINE_GUID(IID_ICommands,0xA5B5FB6C,0x1BBE,0x4B0F,0xB3,0x8D,0x2A,0xF0,0xD9,0x22,0xC9,0x58);
    ...
    {
    public:
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE WTLWizard( void) = 0;
        
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE WINXWizard( void) = 0;
        
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE Options( void) = 0;
    ...
    typedef struct ICommandsVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *WTLWizard )( 
            ICommands __RPC_FAR * This);
        
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *WINXWizard )( 
            ICommands __RPC_FAR * This);
...
#define ICommands_WTLWizard(This)	\
    (This)->lpVtbl -> WTLWizard(This)

#define ICommands_WINXWizard(This)	\
    (This)->lpVtbl -> WINXWizard(This)

#define ICommands_Options(This)	\
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE ICommands_WTLWizard_Proxy( 
    ICommands __RPC_FAR * This);


void __RPC_STUB ICommands_WTLWizard_Stub(
    IRpcStubBuffer *This,
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE ICommands_WINXWizard_Proxy( 
    ICommands __RPC_FAR * This);


void __RPC_STUB ICommands_WINXWizard_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE ICommands_Options_Proxy( 
    ICommands __RPC_FAR * This);


void __RPC_STUB ICommands_Options_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
